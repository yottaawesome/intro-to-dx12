...
void SobelApp::Draw(const GameTimer& gt)
{
	...
	auto transition = CD3DX12_RESOURCE_BARRIER::Transition(mOffscreenRT->Resource(),
	...
	transition = CD3DX12_RESOURCE_BARRIER::Transition(mOffscreenRT->Resource(),
